...
const setupSocket = (server) => {
    console.log("setupSocket called"); // test
    ...
    const sendMessage = async (message) => {
        ...
        const messageData = await Messages.findById(createMessage._id).populate("sender", "id email firstName lastName image color").populate("recipient", "id email firstName lastName image color")
